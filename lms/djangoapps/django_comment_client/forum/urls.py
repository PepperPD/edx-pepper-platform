...
urlpatterns += patterns('portfolio.portfolio_utils',
        url(r'^(?P<discussion_id>[\w\-.]+)/setVisibility/(?P<discussion_visibility>[^/]+)$', 'set_discussion_visibility', name='set_discussion_visibility'),
    )